...
const TelemetryEnvConfig = Config.all({
  ...
  enabled: Config.boolean("ACE_TELEMETRY_ENABLED").pipe(Config.withDefault(true)),
  flushBatchSize: Config.number("ACE_TELEMETRY_FLUSH_BATCH_SIZE").pipe(Config.withDefault(20)),
  maxBufferedEvents: Config.number("ACE_TELEMETRY_MAX_BUFFERED_EVENTS").pipe(
