    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          fork_source_provider_thread_id,
          fork_created_at,
        ...
        VALUES (
          ...
          ${row.branch},
          ${row.worktreePath},
          ${row.handoffSourceThreadId},
          ${row.handoffFromProvider},
          ${row.handoffToProvider},
          ${row.handoffMode},
          ${row.handoffCreatedAt},
          ${row.forkSourceThreadId},
          ${row.forkSourceProviderThreadId},
          ${row.forkCreatedAt},
        ...
        DO UPDATE SET
          ...
          handoff_source_thread_id = excluded.handoff_source_thread_id,
          handoff_from_provider = excluded.handoff_from_provider,
          handoff_to_provider = excluded.handoff_to_provider,
          handoff_mode = excluded.handoff_mode,
          handoff_created_at = excluded.handoff_created_at,
          fork_source_thread_id = excluded.fork_source_thread_id,
          fork_source_provider_thread_id = excluded.fork_source_provider_thread_id,
