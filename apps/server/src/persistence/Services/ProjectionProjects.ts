 ...
 */
import { IsoDateTime, ModelSelection, ProjectIcon, ProjectId, ProjectScript } from "@ace/contracts";
...
>()("ace/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
