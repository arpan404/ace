...
export interface ProviderServiceShape {
  ...
  /**
   * Read effective integration capabilities for a provider.
   */
  readonly getCapabilities: (
    provider: ProviderKind,
  ) => Effect.Effect<ProviderIntegrationCapabilities, ProviderServiceError>;
...
export class ProviderService extends ServiceMap.Service<ProviderService, ProviderServiceShape>()(
  "ace/provider/Services/ProviderService",
) {}
