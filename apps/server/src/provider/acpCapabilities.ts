...
export function acpMultiAgentDefinitionPaths(initializeResult: unknown): string[] {
  ...
  for (const record of acpCapabilityRecords(initializeResult)) {
    values.push(
      ...
      record.chatModeFiles,
      record.chat_mode_files,
      record.subagentFiles,
      record.subagent_files,
      record.agentPaths,
      record.agent_paths,
    ...
    for (const nested of nestedAgentCapabilityRecords(record)) {
      values.push(
        ...
        nested.chatModeFiles,
        nested.chat_mode_files,
        nested.subagentFiles,
        nested.subagent_files,
        nested.agentPaths,
        nested.agent_paths,
