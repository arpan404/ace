...
function providerCapabilitiesFromSessionConfigured(
  ...
  const explicitSessionCapabilities = asRecord(
    capabilities.sessionCapabilities ?? capabilities.session_capabilities,
  );
  const nestedSessionCapabilities = asRecord(
    session?.capabilities ?? session?.providerCapabilities ?? session?.provider_capabilities,
  );
  const sessionCapabilities =
    explicitSessionCapabilities && nestedSessionCapabilities
      ? { ...nestedSessionCapabilities, ...explicitSessionCapabilities }
      : (explicitSessionCapabilities ?? nestedSessionCapabilities);
  ...
  const sessionForkMode =
    normalizeProviderCapabilityMode(
      ...
      sessionCapabilities?.sessionForkMode,
      sessionCapabilities?.session_fork_mode,
      sessionCapabilities?.fork,
      sessionCapabilities?.forkSession,
      sessionCapabilities?.fork_session,
      sessionCapabilities?.sessionFork,
      sessionCapabilities?.session_fork,
      sessionCapabilities?.forkMode,
      sessionCapabilities?.fork_mode,
      sessionCapabilities?.["session.fork"],
      session?.sessionForkMode,
      session?.session_fork_mode,
      session?.fork,
      session?.forkSession,
      ...
      sessions?.sessionForkMode,
      sessions?.session_fork_mode,
      sessions?.fork,
  ...
  const sideConversationMode =
    normalizeProviderCapabilityMode(
      ...
      sessionCapabilities?.side_conversation,
      sessionCapabilities?.sideConversationMode,
      sessionCapabilities?.side_conversation_mode,
      sessionCapabilities?.sideMode,
      sessionCapabilities?.side_mode,
      sessionCapabilities?.sideChat,
      sessionCapabilities?.side_chat,
      sessionCapabilities?.sideSession,
      sessionCapabilities?.side_session,
      sessionCapabilities?.sideThread,
      sessionCapabilities?.side_thread,
      session?.sideConversation,
      session?.side_conversation,
      session?.sideConversationMode,
      session?.side_conversation_mode,
      session?.sideMode,
      session?.side_mode,
      session?.sideChat,
      session?.side_chat,
      ...
      sessions?.side_conversation,
      sessions?.sideConversationMode,
      sessions?.side_conversation_mode,
      sessions?.sideMode,
      sessions?.side_mode,
      sessions?.sideChat,
      sessions?.side_chat,
      sessions?.sideSession,
      sessions?.side_session,
      sessions?.sideThread,
      sessions?.side_thread,
    ) ??
  ...
  const sideConversationCommands = normalizeProviderSideConversationCommands(
    ...
    sessionCapabilities?.side_conversation_commands,
    sessionCapabilities?.sideCommands,
    sessionCapabilities?.side_commands,
    sessionCapabilities?.sideChatCommands,
    sessionCapabilities?.side_chat_commands,
    sessionCapabilities?.sideConversationAliases,
    sessionCapabilities?.side_conversation_aliases,
    sessionCapabilities?.sideAliases,
    sessionCapabilities?.side_aliases,
    session?.sideConversationCommands,
    session?.side_conversation_commands,
    session?.sideCommands,
    session?.side_commands,
    session?.sideChatCommands,
    session?.side_chat_commands,
    session?.sideConversationAliases,
    session?.side_conversation_aliases,
    session?.sideAliases,
    session?.side_aliases,
    sessions?.sideConversationCommands,
    sessions?.side_conversation_commands,
    sessions?.sideCommands,
    sessions?.side_commands,
    sessions?.sideChatCommands,
    sessions?.side_chat_commands,
    sessions?.sideConversationAliases,
    sessions?.side_conversation_aliases,
    sessions?.sideAliases,
    sessions?.side_aliases,
  ...
  const providerThreadTargetingMode =
    normalizeProviderCapabilityMode(
      ...
      sessionCapabilities?.providerThreadTargetingMode,
      sessionCapabilities?.provider_thread_targeting_mode,
      sessionCapabilities?.threadTargetingMode,
      sessionCapabilities?.thread_targeting_mode,
      sessionCapabilities?.threadTargeting,
      sessionCapabilities?.thread_targeting,
      sessionCapabilities?.providerThreadTargeting,
      sessionCapabilities?.provider_thread_targeting,
      sessionCapabilities?.providerSessionTargeting,
      sessionCapabilities?.provider_session_targeting,
      sessionCapabilities?.childThreadTargeting,
      sessionCapabilities?.child_thread_targeting,
      sessionCapabilities?.childSessionTargeting,
      sessionCapabilities?.child_session_targeting,
      sessionCapabilities?.childConversationTargeting,
      sessionCapabilities?.child_conversation_targeting,
      session?.providerThreadTargetingMode,
      session?.provider_thread_targeting_mode,
      session?.threadTargetingMode,
      session?.thread_targeting_mode,
      session?.threadTargeting,
      session?.thread_targeting,
      session?.providerThreadTargeting,
      session?.provider_thread_targeting,
      session?.providerSessionTargeting,
      session?.provider_session_targeting,
      session?.childThreadTargeting,
      session?.child_thread_targeting,
      session?.childSessionTargeting,
      session?.child_session_targeting,
      session?.childConversationTargeting,
      session?.child_conversation_targeting,
      sessions?.providerThreadTargetingMode,
      sessions?.provider_thread_targeting_mode,
      sessions?.threadTargetingMode,
      sessions?.thread_targeting_mode,
      sessions?.threadTargeting,
      sessions?.thread_targeting,
      sessions?.providerThreadTargeting,
      sessions?.provider_thread_targeting,
      sessions?.providerSessionTargeting,
      sessions?.provider_session_targeting,
      sessions?.childThreadTargeting,
      sessions?.child_thread_targeting,
      sessions?.childSessionTargeting,
      sessions?.child_session_targeting,
      sessions?.childConversationTargeting,
      sessions?.child_conversation_targeting,
    ) ??
  ...
  const sessionResumeMode =
    normalizeProviderCapabilityMode(
      ...
      sessionCapabilities?.sessionResumeMode,
      sessionCapabilities?.session_resume_mode,
      sessionCapabilities?.resume,
      sessionCapabilities?.resumeSession,
      sessionCapabilities?.resume_session,
      sessionCapabilities?.sessionResume,
      sessionCapabilities?.session_resume,
      sessionCapabilities?.loadSession,
      sessionCapabilities?.load_session,
      sessionCapabilities?.resumeMode,
      sessionCapabilities?.resume_mode,
      session?.sessionResumeMode,
      session?.session_resume_mode,
      session?.resume,
      ...
      session?.resumeMode,
      session?.resume_mode,
      sessions?.sessionResumeMode,
      sessions?.session_resume_mode,
      sessions?.resume,
  ...
  const turnSteeringMode =
    normalizeProviderCapabilityMode(
      ...
      sessionCapabilities?.turnSteeringMode,
      sessionCapabilities?.turn_steering_mode,
      sessionCapabilities?.steerTurn,
      sessionCapabilities?.steer_turn,
      sessionCapabilities?.turnSteering,
      sessionCapabilities?.turn_steering,
      sessionCapabilities?.steeringMode,
      sessionCapabilities?.steering_mode,
      sessionCapabilities?.["turn.steer"],
      session?.turnSteeringMode,
      session?.turn_steering_mode,
      session?.steerTurn,
      session?.steer_turn,
      session?.turnSteering,
      session?.turn_steering,
      session?.steeringMode,
      session?.steering_mode,
      session?.["turn.steer"],
      sessions?.turnSteeringMode,
      sessions?.turn_steering_mode,
      sessions?.steerTurn,
      sessions?.steer_turn,
      sessions?.turnSteering,
      sessions?.turn_steering,
      sessions?.steeringMode,
      sessions?.steering_mode,
      sessions?.["turn.steer"],
      turn?.steer,
      turn?.steerTurn,
      turn?.steer_turn,
  ...
  const goalControlMode =
    normalizeProviderCapabilityMode(
      ...
      capabilities["thread/goal/clear"],
      sessionCapabilities?.goalControlMode,
      sessionCapabilities?.goal_control_mode,
      sessionCapabilities?.goalControl,
      sessionCapabilities?.goal_control,
      sessionCapabilities?.goalControls,
      sessionCapabilities?.goal_controls,
      sessionCapabilities?.threadGoal,
      sessionCapabilities?.thread_goal,
      sessionCapabilities?.threadGoalControl,
      sessionCapabilities?.thread_goal_control,
      session?.goalControlMode,
      session?.goal_control_mode,
      session?.goalControl,
      session?.goal_control,
      session?.goalControls,
      session?.goal_controls,
      session?.threadGoal,
      session?.thread_goal,
      session?.threadGoalControl,
      session?.thread_goal_control,
      sessions?.goalControlMode,
      sessions?.goal_control_mode,
      sessions?.goalControl,
      sessions?.goal_control,
      sessions?.goalControls,
      sessions?.goal_controls,
      sessions?.threadGoal,
      sessions?.thread_goal,
      sessions?.threadGoalControl,
      sessions?.thread_goal_control,
  ...
  const multiAgentMode =
    normalizeProviderMultiAgentMode(
      ...
      sessionCapabilities?.multiAgentMode,
      sessionCapabilities?.multi_agent_mode,
      sessionCapabilities?.agentMode,
      sessionCapabilities?.agent_mode,
      sessionCapabilities?.multiAgent,
      sessionCapabilities?.multi_agent,
      sessionCapabilities?.multiAgents,
      sessionCapabilities?.multi_agents,
      sessionCapabilities?.subagents,
      sessionCapabilities?.subAgents,
      sessionCapabilities?.sub_agents,
      sessionCapabilities?.agents,
      sessionCapabilities?.agentTeams,
      sessionCapabilities?.agent_teams,
      session?.multiAgentMode,
      session?.multi_agent_mode,
      session?.agentMode,
      session?.agent_mode,
      session?.multiAgent,
      session?.multi_agent,
      session?.multiAgents,
      session?.multi_agents,
      session?.subagents,
      session?.subAgents,
      session?.sub_agents,
      session?.agents,
      session?.agentTeams,
      session?.agent_teams,
      sessions?.multiAgentMode,
      sessions?.multi_agent_mode,
      sessions?.agentMode,
      sessions?.agent_mode,
      sessions?.multiAgent,
      sessions?.multi_agent,
      sessions?.multiAgents,
      sessions?.multi_agents,
      sessions?.subagents,
      sessions?.subAgents,
      sessions?.sub_agents,
      sessions?.agents,
  ...
  const multiAgentInvocationPrefixes = normalizeProviderCapabilityStringList(
    ...
    sessionCapabilities?.multi_agent_invocation_prefixes,
    sessionCapabilities?.agentInvocationPrefixes,
    sessionCapabilities?.agent_invocation_prefixes,
    sessionCapabilities?.subagentInvocationPrefixes,
    sessionCapabilities?.subagent_invocation_prefixes,
    sessionCapabilities?.agentPrefixes,
    sessionCapabilities?.agent_prefixes,
    sessionCapabilities?.subagentPrefixes,
    sessionCapabilities?.subagent_prefixes,
    session?.multiAgentInvocationPrefixes,
    session?.multi_agent_invocation_prefixes,
    session?.agentInvocationPrefixes,
    session?.agent_invocation_prefixes,
    session?.subagentInvocationPrefixes,
    session?.subagent_invocation_prefixes,
    session?.agentPrefixes,
    session?.agent_prefixes,
    session?.subagentPrefixes,
    session?.subagent_prefixes,
    sessions?.multiAgentInvocationPrefixes,
    sessions?.multi_agent_invocation_prefixes,
    sessions?.agentInvocationPrefixes,
    sessions?.agent_invocation_prefixes,
    sessions?.subagentInvocationPrefixes,
    sessions?.subagent_invocation_prefixes,
    sessions?.agentPrefixes,
    sessions?.agent_prefixes,
    sessions?.subagentPrefixes,
    sessions?.subagent_prefixes,
  ...
  const multiAgentDefinitionPaths = normalizeProviderCapabilityStringList(
    ...
    capabilities.agentFilesLocations,
    capabilities.agent_files_locations,
    capabilities.agentFiles,
    capabilities.agent_files,
    capabilities.chatModeFilesLocations,
    capabilities.chat_mode_files_locations,
    capabilities.chatModeFiles,
    capabilities.chat_mode_files,
    capabilities.subagentFiles,
    capabilities.subagent_files,
    ...
    sessionCapabilities?.multi_agent_definition_paths,
    sessionCapabilities?.agentDefinitionPaths,
    sessionCapabilities?.agent_definition_paths,
    sessionCapabilities?.subagentDefinitionPaths,
    sessionCapabilities?.subagent_definition_paths,
    sessionCapabilities?.agentFilesLocations,
    sessionCapabilities?.agent_files_locations,
    sessionCapabilities?.agentFiles,
    sessionCapabilities?.agent_files,
    sessionCapabilities?.chatModeFilesLocations,
    sessionCapabilities?.chat_mode_files_locations,
    sessionCapabilities?.chatModeFiles,
    sessionCapabilities?.chat_mode_files,
    sessionCapabilities?.subagentFiles,
    sessionCapabilities?.subagent_files,
    sessionCapabilities?.agentPaths,
    sessionCapabilities?.agent_paths,
    sessionCapabilities?.subagentPaths,
    sessionCapabilities?.subagent_paths,
    session?.multiAgentDefinitionPaths,
    session?.multi_agent_definition_paths,
    session?.agentDefinitionPaths,
    session?.agent_definition_paths,
    session?.subagentDefinitionPaths,
    session?.subagent_definition_paths,
    session?.agentFilesLocations,
    session?.agent_files_locations,
    session?.agentFiles,
    session?.agent_files,
    session?.chatModeFilesLocations,
    session?.chat_mode_files_locations,
    session?.chatModeFiles,
    session?.chat_mode_files,
    session?.subagentFiles,
    session?.subagent_files,
    session?.agentPaths,
    session?.agent_paths,
    session?.subagentPaths,
    session?.subagent_paths,
    sessions?.multiAgentDefinitionPaths,
    sessions?.multi_agent_definition_paths,
    sessions?.agentDefinitionPaths,
    sessions?.agent_definition_paths,
    sessions?.subagentDefinitionPaths,
    sessions?.subagent_definition_paths,
    sessions?.agentFilesLocations,
    sessions?.agent_files_locations,
    sessions?.agentFiles,
    sessions?.agent_files,
    sessions?.chatModeFilesLocations,
    sessions?.chat_mode_files_locations,
    sessions?.chatModeFiles,
    sessions?.chat_mode_files,
    sessions?.subagentFiles,
    sessions?.subagent_files,
    sessions?.agentPaths,
    sessions?.agent_paths,
    sessions?.subagentPaths,
    sessions?.subagent_paths,
  ...
  const multiAgentManagementCommands = normalizeProviderCapabilityStringList(
    ...
    sessionCapabilities?.multi_agent_management_commands,
    sessionCapabilities?.agentManagementCommands,
    sessionCapabilities?.agent_management_commands,
    sessionCapabilities?.subagentManagementCommands,
    sessionCapabilities?.subagent_management_commands,
    sessionCapabilities?.agentCommands,
    sessionCapabilities?.agent_commands,
    sessionCapabilities?.subagentCommands,
    sessionCapabilities?.subagent_commands,
    session?.multiAgentManagementCommands,
    session?.multi_agent_management_commands,
    session?.agentManagementCommands,
    session?.agent_management_commands,
    session?.subagentManagementCommands,
    session?.subagent_management_commands,
    session?.agentCommands,
    session?.agent_commands,
    session?.subagentCommands,
    session?.subagent_commands,
    sessions?.multiAgentManagementCommands,
    sessions?.multi_agent_management_commands,
    sessions?.agentManagementCommands,
    sessions?.agent_management_commands,
    sessions?.subagentManagementCommands,
    sessions?.subagent_management_commands,
    sessions?.agentCommands,
    sessions?.agent_commands,
    sessions?.subagentCommands,
    sessions?.subagent_commands,
  ...
  const remoteAgentMode =
    normalizeProviderRemoteAgentMode(
      ...
      sessionCapabilities?.remoteAgentMode,
      sessionCapabilities?.remote_agent_mode,
      sessionCapabilities?.remoteAgentsMode,
      sessionCapabilities?.remote_agents_mode,
      sessionCapabilities?.remoteAgent,
      sessionCapabilities?.remote_agent,
      sessionCapabilities?.remoteAgents,
      sessionCapabilities?.remote_agents,
      sessionCapabilities?.hostedAgent,
      sessionCapabilities?.hosted_agent,
      sessionCapabilities?.hostedAgents,
      sessionCapabilities?.hosted_agents,
      sessionCapabilities?.cloudAgent,
      sessionCapabilities?.cloud_agent,
      sessionCapabilities?.cloudAgents,
      sessionCapabilities?.cloud_agents,
      sessionCapabilities?.a2aAgent,
      sessionCapabilities?.a2a_agent,
      sessionCapabilities?.a2aAgents,
      sessionCapabilities?.a2a_agents,
      sessionCapabilities?.agentConnect,
      sessionCapabilities?.agent_connect,
      sessionCapabilities?.remoteDelegation,
      sessionCapabilities?.remote_delegation,
      session?.remoteAgentMode,
      session?.remote_agent_mode,
      session?.remoteAgentsMode,
      session?.remote_agents_mode,
      session?.remoteAgent,
      session?.remote_agent,
      session?.remoteAgents,
      session?.remote_agents,
      session?.hostedAgent,
      session?.hosted_agent,
      session?.hostedAgents,
      session?.hosted_agents,
      session?.cloudAgent,
      session?.cloud_agent,
      session?.cloudAgents,
      session?.cloud_agents,
      session?.a2aAgent,
      session?.a2a_agent,
      session?.a2aAgents,
      session?.a2a_agents,
      session?.agentConnect,
      session?.agent_connect,
      session?.remoteDelegation,
      session?.remote_delegation,
      sessions?.remoteAgentMode,
      sessions?.remote_agent_mode,
      sessions?.remoteAgentsMode,
      sessions?.remote_agents_mode,
      sessions?.remoteAgent,
      sessions?.remote_agent,
      sessions?.remoteAgents,
      sessions?.remote_agents,
      sessions?.hostedAgent,
      sessions?.hosted_agent,
      sessions?.hostedAgents,
      sessions?.hosted_agents,
      sessions?.cloudAgent,
      sessions?.cloud_agent,
      sessions?.cloudAgents,
      sessions?.cloud_agents,
      sessions?.a2aAgent,
      sessions?.a2a_agent,
      sessions?.a2aAgents,
      sessions?.a2a_agents,
      sessions?.agentConnect,
      sessions?.agent_connect,
      sessions?.remoteDelegation,
      sessions?.remote_delegation,
  ...
  const webAccessMode =
    normalizeProviderWebAccessMode(
      ...
      sessionCapabilities?.webAccessMode,
      sessionCapabilities?.web_access_mode,
      sessionCapabilities?.webMode,
      sessionCapabilities?.web_mode,
      sessionCapabilities?.webAccess,
      sessionCapabilities?.web_access,
      sessionCapabilities?.webSearch,
      sessionCapabilities?.web_search,
      sessionCapabilities?.webFetch,
      sessionCapabilities?.web_fetch,
      sessionCapabilities?.webTools,
      sessionCapabilities?.web_tools,
      sessionCapabilities?.browser,
      sessionCapabilities?.browsing,
      sessionCapabilities?.research,
      sessionCapabilities?.internetAccess,
      sessionCapabilities?.internet_access,
      session?.webAccessMode,
      session?.web_access_mode,
      session?.webMode,
      session?.web_mode,
      session?.webAccess,
      session?.web_access,
      ...
      session?.internet_access,
      sessions?.webAccessMode,
      sessions?.web_access_mode,
      sessions?.webMode,
      sessions?.web_mode,
      sessions?.webAccess,
      sessions?.web_access,
  ...
  const hostedSessionMode =
    normalizeProviderHostedSessionMode(
      ...
      sessionCapabilities?.hostedSessionMode,
      sessionCapabilities?.hosted_session_mode,
      sessionCapabilities?.cloudSessionMode,
      sessionCapabilities?.cloud_session_mode,
      sessionCapabilities?.backgroundSessionMode,
      sessionCapabilities?.background_session_mode,
      sessionCapabilities?.hostedSession,
      sessionCapabilities?.hosted_session,
      sessionCapabilities?.hostedSessions,
      sessionCapabilities?.hosted_sessions,
      sessionCapabilities?.cloudSession,
      sessionCapabilities?.cloud_session,
      sessionCapabilities?.cloudSessions,
      sessionCapabilities?.cloud_sessions,
      sessionCapabilities?.cloudTask,
      sessionCapabilities?.cloud_task,
      sessionCapabilities?.cloudTasks,
      sessionCapabilities?.cloud_tasks,
      sessionCapabilities?.backgroundAgent,
      sessionCapabilities?.background_agent,
      sessionCapabilities?.backgroundAgents,
      sessionCapabilities?.background_agents,
      sessionCapabilities?.webAgent,
      sessionCapabilities?.web_agent,
      sessionCapabilities?.webAgents,
      sessionCapabilities?.web_agents,
      sessionCapabilities?.remoteSession,
      sessionCapabilities?.remote_session,
      sessionCapabilities?.remoteSessions,
      sessionCapabilities?.remote_sessions,
      sessionCapabilities?.remoteControl,
      sessionCapabilities?.remote_control,
      sessionCapabilities?.teleport,
      session?.hostedSessionMode,
      session?.hosted_session_mode,
      session?.cloudSessionMode,
      session?.cloud_session_mode,
      session?.backgroundSessionMode,
      session?.background_session_mode,
      session?.hostedSession,
      session?.hosted_session,
      session?.hostedSessions,
      session?.hosted_sessions,
      ...
      session?.teleport,
      sessions?.hostedSessionMode,
      sessions?.hosted_session_mode,
      sessions?.cloudSessionMode,
      sessions?.cloud_session_mode,
      sessions?.backgroundSessionMode,
      sessions?.background_session_mode,
      sessions?.hostedSession,
      sessions?.hosted_session,
      sessions?.hostedSessions,
      sessions?.hosted_sessions,
      sessions?.cloudSession,
      sessions?.cloud_session,
      sessions?.cloudSessions,
      sessions?.cloud_sessions,
      sessions?.cloudTask,
      sessions?.cloud_task,
      sessions?.cloudTasks,
      sessions?.cloud_tasks,
      sessions?.backgroundAgent,
      sessions?.background_agent,
      sessions?.backgroundAgents,
      sessions?.background_agents,
      sessions?.webAgent,
      sessions?.web_agent,
      sessions?.webAgents,
      sessions?.web_agents,
