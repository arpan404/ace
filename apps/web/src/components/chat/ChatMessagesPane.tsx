      ...
      {showScrollToBottom && (
        <div className="pointer-events-none absolute bottom-1 left-1/2 z-30 flex -translate-x-1/2 justify-center py-1.5">
          <Button
            ...
            className="pointer-events-auto rounded-full border-border/70 bg-background/95 text-foreground shadow-sm hover:bg-background hover:text-foreground active:bg-background"
