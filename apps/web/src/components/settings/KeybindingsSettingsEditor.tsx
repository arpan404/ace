            ...
            {(expandedGroups[group.category]
              ...
              return (
                <div
                  ...
                  className="grid gap-2 rounded-[var(--control-radius)] px-3 py-2.5 transition-colors hover:bg-foreground/[0.025] md:grid-cols-[minmax(0,1fr)_200px] md:items-center"
                >
