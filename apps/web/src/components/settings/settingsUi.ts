...
export const SETTINGS_COLOR_SWATCH_BUTTON_CLASS = cn(
  "size-7 shrink-0 rounded-full border border-transparent shadow-none",
  SETTINGS_SIDEBAR_FOCUS_RING_CLASS,
);

export const SETTINGS_LIST_ROW_BUTTON_CLASS = cn(
  "h-auto justify-start text-left font-normal shadow-none",
  SETTINGS_SIDEBAR_FOCUS_RING_CLASS,
);

export const SETTINGS_WIZARD_STEP_BUTTON_CLASS = cn(
  "h-7 rounded-[calc(var(--control-radius)-2px)] px-2 text-xs font-normal shadow-none",
  SETTINGS_SIDEBAR_FOCUS_RING_CLASS,
);
...
export const SETTINGS_PROVIDER_DETAIL_SECTION_CLASS =
  "border-b border-border/40 px-3 py-3 last:border-b-0";
