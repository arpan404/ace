    ...
    <DialogPortal>
      ...
      >
        <DialogPrimitive.Popup
          className={cn(
            "-translate-y-[calc(1.25rem*var(--nested-dialogs))] relative row-start-2 flex max-h-full min-h-0 w-full min-w-0 max-w-lg scale-[calc(1-0.1*var(--nested-dialogs))] flex-col rounded-[var(--panel-radius)] border border-border/72 bg-popover/96 text-popover-foreground opacity-[calc(1-0.1*var(--nested-dialogs))] shadow-[0_24px_56px_-38px_color-mix(in_oklch,var(--foreground)_34%,transparent)] supports-[backdrop-filter]:bg-popover/88 supports-[backdrop-filter]:backdrop-blur-xl transition-[scale,opacity,translate] duration-200 ease-in-out will-change-transform data-nested:data-ending-style:translate-y-8 data-nested:data-starting-style:translate-y-8 data-nested-dialog-open:origin-top data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0",
            bottomStickOnMobile &&
