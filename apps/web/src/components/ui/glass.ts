...
export const GLASS_CONTROL_CLASS_NAME =
  "border border-border/50 bg-[color:color-mix(in_oklab,var(--background)_90%,var(--popover)_10%)] shadow-none transition-[border-color,background-color,box-shadow] supports-[backdrop-filter]:backdrop-blur-xl supports-[backdrop-filter]:backdrop-saturate-[1.12] has-focus-visible:border-ring/55 has-focus-visible:ring-2 has-focus-visible:ring-ring/15 dark:bg-[color:color-mix(in_oklab,var(--input)_82%,var(--background)_18%)] dark:has-focus-visible:bg-[color:color-mix(in_oklab,var(--input)_88%,var(--background)_12%)]";
...
export const GLASS_FOOTER_CLASS_NAME =
  "border-t border-border/30 bg-[color:color-mix(in_oklab,var(--muted)_76%,var(--background)_24%)] supports-[backdrop-filter]:backdrop-blur-xl supports-[backdrop-filter]:backdrop-saturate-[1.12]";
