...
const KEYBINDING_DEFINITION_BY_COMMAND: Record<StaticKeybindingCommand, KeybindingDefinitionMeta> =
  {
    ...
    "rightPanel.fullscreen.toggle": {
      ...
      description: "Enter or exit full-screen mode for the right side panel.",
      defaultShortcut: {
        key: "f",
        modKey: true,
        ctrlKey: false,
      ...
      context: { ...CHAT_CONTEXT, rightPanelOpen: true },
    },
    "rightPanel.floatingChat.toggle": {
      category: "Right Panel",
      label: "Toggle floating chat input",
      description: "Show or hide the floating chat input in full-screen right panel mode.",
      defaultShortcut: {
        key: "c",
        modKey: true,
        ctrlKey: false,
      ...
      context: { ...CHAT_CONTEXT, rightPanelFullscreen: true },
    },
    "browser.back": {
      category: "Browser",
      label: "Browser back",
    ...
    "browser.designer.areaComment": {
      category: "Browser",
      label: "Annotate browser area",
      description: "Select an area in the browser and leave a comment.",
      when: "browserOpen && !terminalFocus",
      context: BROWSER_CONTEXT,
    },
    "browser.designer.elementComment": {
      category: "Browser",
      label: "Comment on browser element",
      description: "Select a page element in the browser and leave a comment.",
      when: "browserOpen && !terminalFocus",
      context: BROWSER_CONTEXT,
    },
    "chat.new": {
