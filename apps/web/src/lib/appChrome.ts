...
const APP_CHROME_SIDEBAR_CLASS_NAME = "bg-sidebar text-sidebar-foreground";
...
export const APP_COMPOSER_CLASS_NAME =
  "rounded-[1.625rem] border border-[color:var(--composer-border)] bg-[var(--composer-surface)] text-foreground shadow-none transition-[background-color,border-color] duration-150 supports-[backdrop-filter]:backdrop-blur-2xl supports-[backdrop-filter]:backdrop-saturate-[var(--composer-saturate)]";
