...
export const DESKTOP_SIDEBAR_TOGGLE_CLASS_NAME =
  "size-8 shrink-0 rounded-lg border border-transparent bg-transparent text-foreground/45 shadow-none transition-all hover:border-border/60 hover:bg-background/60 hover:text-foreground hover:shadow-sm";
