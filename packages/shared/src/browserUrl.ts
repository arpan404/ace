...
import { normalizeWsUrl, splitWsUrlAuthToken, wsUrlToBrowserBaseUrl } from "./hostConnections";
...
export const DEFAULT_BROWSER_HOME_URL = SEARCH_ENGINE_CONFIG[DEFAULT_BROWSER_SEARCH_ENGINE].homeUrl;
