...
export function providerAgentMetadataFromRecord(
  ...
  const genericId = firstTrimmedString(
    ...
    record.hostedAgentId,
    record.hosted_agent_id,
    record.cloudAgentId,
    record.cloud_agent_id,
    record.backgroundAgentId,
  ...
  const type = firstTrimmedString(
    ...
    record.remoteAgentType,
    record.remote_agent_type,
    record.hostedAgentType,
    record.hosted_agent_type,
    record.cloudAgentType,
    record.cloud_agent_type,
    record.backgroundAgentType,
    record.background_agent_type,
    record.webAgentType,
    record.web_agent_type,
    record.a2aAgentType,
    record.a2a_agent_type,
    record.agentCardType,
    record.agent_card_type,
    record.profileType,
    record.profile_type,
    record.personaType,
    record.persona_type,
  ...
  const name = firstTrimmedString(
    ...
    record.remoteAgentName,
    record.remote_agent_name,
    record.hostedAgentName,
    record.hosted_agent_name,
    record.cloudAgentName,
    record.cloud_agent_name,
    record.backgroundAgentName,
    record.background_agent_name,
    record.webAgentName,
    record.web_agent_name,
    record.a2aAgentName,
    record.a2a_agent_name,
    record.agentCardName,
    record.agent_card_name,
    record.profileName,
    record.profile_name,
    record.personaName,
    record.persona_name,
