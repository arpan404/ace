...
export type BrowserHistory = ReadonlyArray<BrowserHistoryEntry>;
...
type BrowserTabSuggestionInput = {
  readonly id: string;
  readonly title: string;
  readonly url: string;
};
...
export function buildBrowserSuggestions(
  ...
  options: {
    ...
    history: BrowserHistory;
    now?: number;
    openTabs?: readonly BrowserTabSuggestionInput[];
