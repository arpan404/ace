...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct PullRequestReviewThreadsRequest {
    pub repo_path: String,
    pub number: u32,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct PullRequestMergeStatusRequest {
    pub repo_path: String,
    pub selector: String,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CheckRunRerequestRequest {
    pub repo_path: String,
    pub check_run_id: u64,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CheckSuiteRerequestRequest {
    pub repo_path: String,
    pub check_suite_id: u64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct WorkflowRunJobsRequest {
    pub repo_path: String,
    pub run_id: u64,
    pub attempt: Option<u32>,
    pub limit: u32,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct WorkflowJobRequest {
    pub repo_path: String,
    pub job_id: u64,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct WorkflowJobLogRequest {
    pub repo_path: String,
    pub job_id: u64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct WorkflowRunApprovalsRequest {
    pub repo_path: String,
    pub run_id: u64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct WorkflowRunForceCancelRequest {
    pub repo_path: String,
    pub run_id: u64,
}
