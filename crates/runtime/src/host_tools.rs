...
fn operation_for_action(action: ToolActionKind) -> &'static str {
    match action {
        ...
        ToolActionKind::RealtimeStart => "realtime_start",
        ToolActionKind::RealtimeStop => "realtime_stop",
        ToolActionKind::RealtimeAppendText => "realtime_append_text",
        ToolActionKind::RealtimeAppendSpeech => "realtime_append_speech",
        ToolActionKind::RealtimeAppendAudio => "realtime_append_audio",
        ToolActionKind::RealtimeListVoices => "realtime_list_voices",
